...
public class Efeitos {
	private static final byte EFEITOS = 6;
	public static final byte item_obtido = 0, item_recebido = 1, sword_atack = 2;
	...
	public static void init() {
		...
		efeitos[2] = new AudioPlayer("/audios/efects/swordSlash.mp3");
	}
